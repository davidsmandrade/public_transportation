...
class Weather(Producer):
    ...
    def __init__(self, month):
        ...
        #Define this value schema in `schemas/weather_value.json ##step2
    ...
    def run(self, month):
        ...
        # specify the Avro schemas and verify that you are using the correct Content-Type header. ##step4
        resp = requests.post(
